...
<div class="container">
            ...
            <ul>
                <li><b>Fizička lica:</b>prodaja@bakariTech.rs</li>
                <li><b>Pravna lica:</b>corporate@bakariTech.rs</li>
            </ul><br>
            <p><b>Radno vreme Call Centra:</b> ponedeljak - petak od 8 do 20h; subota od 9 do 16h; nedelja neradni dan</p><br>
            <p>Putem Call Centra BakariTech možete da:</p><br>
            <ul>
                <li>izvršite naručivanje robe</li>
                <li>informišete se o načinima plaćanja, radnom vremenu i uslovima isporuke</li>
                <li>dobijete ostale informacije u vezi kupovine u BakariTech</li>
            </ul>
            <h3>Ponude</h3>
            <p>Ukoliko ste zainteresovani za poslovnu saradnju sa nama ili nudite određenu robu ili usluge, molimo Vas kontaktirajte nas na sledeći email: <b>ponude@bakariTech.rs</b> </p>
            <h3>Zaposlenje</h3>
            <p>Ukoliko želite da se pridružite timu BakariTech prijavite se za posao na email <b>posao@bakariTech.rs</b></p>
</div>
