...
<body>
 ...
 <h2 class="text-center">Uslovi online kupovine</h2>
            ...
            molimo vas da pažljivo pročitate uslove korišćenja pre upotrebe BakariTech internet sajta. Korišćenjem našeg internet sajta potvrđujete da ste pročitali, razumeli i prihvatili ove uslove korišćenja (u daljem tekstu: Uslovi).
            BakariTech Beograd zadržava pravo da u bilo kom trenutku izmeni Uslove unošenjem izmena u ovaj tekst. Predlažemo da s vremena na vreme posetite ovu internet stranicu i proverite da li su se Uslovi možda promenili od vaše poslednje posete.
            1. Korisnik je svako lice koje pristupa sajtu www.bakariTech.rs i svim njegovim sadržajima.
            ...
            3. Prodavac u konkretnom slučaju je BakariTech.
            BakariTech na sajtu sadržaje objavljuje u dobroj nameri. Sve sadržaje www.bakariTech.rs sajta koristite isključivo na vlastitu odgovornost i BakariTech se ne može smatrati odgovornom za bilo kakvu štetu nastalu korišćenjem.
            Sadržaji objavljeni na internet sajtu BakariTech, vlasništvo su BakariTech i mogu se upotrebljavati samo u nekomercijalne svrhe, pri čemu se moraju poštovati i sva navedena upozorenja o autorskim pravima.
            Sadržaj prikazan na ovom sajtu kao što su stranice, dizajnerski elementi (dugmići, ikonice i sl), tekstovi, logotipi, audio zapisi i softver su vlasništvo BakariTech i ne mogu se koristiti bez prethodne saglasnosti.
            ...
            <p>Na sajtu BakariTech nije moguće obaviti kupovinu i kao gost, odnosno bez registracije.</p>
            <h3>Cene</h3>
            <p>Sve cene navedene na sajtu su finalne na dan porudžbine i u njih je uključen PDV. Sve cene su date u dinarima.
            Po zaključenju porudžbine na sajtu, dobićete e-mail potvrdu porudžbine. Ovaj e-mail sadrži vaše podatke, koje ste ostavili prilikom poručivanja. Tek nakon dostavljanja potvrde od strane BakariTech na mail potrošača, ugovor o prodaji se smatra zaključenim. U slučaju da nismo u mogućnosti da potvrdimo porudžbinu i zaključimo ugovor, bićete obavešteni.</p>
            ...
            U slučaju vraćanja robe i povraćaja sredstava kupcu koji je prethodno platio nekom od platnih kartica putem interneta, delimično ili u celosti, a bez obzira na razlog vraćanja, BakariTech je u obavezi da povraćaj vrši isključivo preko VISA i Maestro metoda plaćanja, što znači da će banka na zahtev prodavca obaviti povraćaj sredstava na račun korisnika kartice. U slučaju plaćanja gotovinom, potrošaču se gotovina i vraća.</p>
